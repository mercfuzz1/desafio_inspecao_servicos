...
class FakeSyncService implements SyncService {
  ...
  bool waitForSyncCompletion = false;
...
void main() {
  group('SyncBloc', () {
    ...
    test(
      'não deve iniciar uma segunda sincronização enquanto a primeira estiver em andamento',
      () async {
        syncService.waitForSyncCompletion =
            true;
