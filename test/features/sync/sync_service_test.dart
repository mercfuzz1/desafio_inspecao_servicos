...
class FakeInspectionsRepository
  ...
  Future<String> send(
    ...
    serverIds[inspection.clientId] = serverId;
  ...
  Future<Inspection?> getByClientId(
    ...
    for (final inspection in [
      ...
      if (inspection.clientId == clientId) {
        return inspection;
      }
    }
...
Inspection createInspection({
  ...
  return Inspection(
    ...
    latitude: -7.1195,
    longitude: -34.8450,
    capturedAt: DateTime(2026, 8, 16, 10),
    syncStatus: status,
    syncError: null,
...
void main() {
  group('SyncServiceImpl', () {
    test(
      ...
      () async {
        final inspection = createInspection();
        ...
        expect(
          repository.sentInspections.first.clientId,
          'client_001',
        );
